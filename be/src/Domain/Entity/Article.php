...
class Article
{
    ...
    {
        if (is_string($publicResultData)) {
            /** @var array<string, mixed>|null $decoded */
            $decoded = json_decode($publicResultData, true);
            $this->publicResultData = $decoded;
        } else {
            $this->publicResultData = $publicResultData;
        }
    ...
    public function markWithdrawn(DateTimeImmutable $at): void
    {
        $this->withdrawnAt = $at;
        $this->publicResultData = null;
    }
